...
<div class="wrap">
	<h2>LIST ASSOCIATION RULE(S)<a class="add-new-h2"
	                               href=<?php echo $addNew_url ?>>Add
			Association Rule</a><a class="add-new-h2"
	                               href=<?php echo $manual_sync_url ?>>Manually
			Synchronize</a></h2>
</div>
...
<table cellspacing="0" class="wp-list-table widefat fixed users">
	...
	<?php foreach ( $select as $key => $value ) { ?>
      ...
      <a href="<?php echo $edit_url ?>">Edit</a> | </span>
					<span class="delete"><a href="<?php echo $delete_url ?>"
